...
class OC_Theme
{
    ...
    public function __construct()
    {
        ...
        $footer_links = [
            "<a href=\"{$this->baseUrl}/apps/core/templates/impressum.html\">Impressum</a>",
            "<a href=\"{$this->baseUrl}/apps/core/templates/data-privacy-statement.html\">Data Privacy Statement</a>",
        ];
